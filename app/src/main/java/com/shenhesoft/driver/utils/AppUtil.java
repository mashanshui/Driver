...
public class AppUtil {
     ...
     * @return
     */
    public static boolean HasTask(String orderid) {
        if (getAppSPObj().getObject("task", TaskBean.class) != null) {
            if ((getAppSPObj().getObject("task", TaskBean.class).getOrderId() == orderid)) {
                return true;
            }
        }
        return false;
     ...
     * @return
     */
    public static String javabeanToJson(UpdatalocationBean person) {
        Gson gson = new Gson();
